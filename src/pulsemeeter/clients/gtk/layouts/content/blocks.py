...
def arrange_widgets(content):
    ...
    grid.attach(DeviceBox(content.app_box['sink_input'], PRETTY['sink_input']), 0, 2, 1, 1)
    grid.attach(DeviceBox(content.app_box['source_output'], PRETTY['source_output']), 1, 2, 1, 1)
